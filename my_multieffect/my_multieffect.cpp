/*
    ...
    #TODO: Add low pass filter to delay (SetLpFreq())
    #TODO: Replace BitCrusher with Overdrive
    #TODO: Chain effects: Multiple effects ON at the same time.
           # NOTE: How to control effect order in effect chain
           # Example: IN - > Distortion -> Delay -> Reverb -> OUT
    #TODO: Add button to control Effect ON / OFF
    #TODO: Add more effects:
    #      Reverse Reverb (reverbsc.h)
    #      Chorus/phaser etc (tremolo.h, phaser.h)
    #      Fuzz/Distortion (overdrive.h)
    #      Pitch Shift (pitchshifter.h) NOTE! Check SetFun() for fun!
    #      Harmonics (...harmonic_osc.h ?)
    #      etc..
